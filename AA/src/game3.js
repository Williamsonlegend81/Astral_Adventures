...
function unflipCards() {
  lockBoard = true;
  setTimeout(() => {
    firstCard.classNameList.remove('flip');
    secondCard.classNameList.remove('flip');
...
function resetGame() {
  ...
  cards.forEach(card => card.classNameList.remove('flip')); // Flip all cards back
